                                    ...
                                    <div class="col-auto">
                                        <div class="d-flex">
                                            ...
                                            <a href="" class="icon-button bg-warning-custom text-white"
                                                data-bs-toggle="modal" data-bs-target="#successVerification" data-id="<?= $doc['id_document']; ?>">
                                                <i class="bi bi-check-lg"></i>
                                            </a>

                                            <a href="" class="icon-button bg-danger-custom text-white"
                                                data-bs-toggle="modal" data-bs-target="#btlVerification" data-id="<?= $doc['id_document']; ?>">
...
<div class="modal fade" id="successVerificationModal" tabindex="-1" aria-labelledby="successVerificationModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="successVerificationModalLabel">Sukses</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <p>Dokumen berhasil diverifikasi.</p>
            </div>
            <div class="modal-footer">
...
<div class="modal fade" id="successRejectionModal" tabindex="-1" aria-labelledby="successRejectionModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="successRejectionModalLabel">Sukses</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <p>Dokumen berhasil ditolak.</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" data-bs-dismiss="modal">OK</button>
            </div>
